...
class CNN_biLSTM(nn.Module):
    ...
    def __init__(self, in_channels=3, nb_filters1=32, nb_filters2=64, kernel_size=3, dropout_rate1=0.25,
        ...
        self.lstm = nn.LSTM(input_size=16384, hidden_size=1000,
        ...
        # Dense layers
        if img_size == 36:
            self.final_dense_1 = nn.Linear(2*3136, self.nb_dense, bias=True)
        elif img_size == 72:
            self.final_dense_1 = nn.Linear(2*1000, self.nb_dense, bias=True)
        elif img_size == 96:
    ...
    def forward(self, inputs, params=None):
        ...
        # raw_input = raw_input.view(2, n//2, c*h*w)
        # print("raw_input", raw_input.shape)
        # lstm_output, _ = self.lstm(raw_input)
        # print("lstm_output", lstm_output.shape)
        # # lstm_output = lstm_output.new()
